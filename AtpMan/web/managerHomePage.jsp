                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <a href="building" style="text-decoration: none">
                            ...
                            <!-- Earnings (Monthly) Card Example -->
                            <div class="col-xl-3 col-md-6 mb-4">
                                <a href="/AtpMan/managerinvoicestatistic" style="text-decoration: none">
                                        ...
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">${requestScope.totalInvoice} hóa đơn</div>
                                                </div>
                                                <div class="col-auto">
                            ...
                            <!-- Earnings (Monthly) Card Example -->
                            <div class="col-xl-3 col-md-6 mb-4">
                                <a href="/AtpMan/servicelist" style="text-decoration: none">
                                    <div class="card border-left-success shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <a href="assignment" style="text-decoration: none">
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <a href="newsmanage" style="text-decoration: none">
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <a href="complaintlist" style="text-decoration: none">

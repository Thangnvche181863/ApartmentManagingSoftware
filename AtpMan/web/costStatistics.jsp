                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="addfinance.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="width: 150px"> Tạo hóa đơn</a>
                        </div>
                                            ...
                                            <div class="form-group mb-4" style="width: 15%">
                                                ...
                                                <select class="form-select w-100" name="typeBuilding" id="typeBuilding">
                                                    <c:forEach items="${buildings}" var="ls">
                                                        <option value="${ls.buildingID}" >${ls.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>                                      
                                        </div>

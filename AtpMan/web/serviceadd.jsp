                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row"
                            ...
                            <form action="serviceadd" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
                                <div class="row g-0"> 
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="file" class="form-control w-100" name="img" id="img" accept="image/*" onchange="previewImg(event)">
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control w-100" name="fee" id="fee">
                                            <div id="feeError" class="text-danger" style="display: none;"></div>                                 
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="icon" class="form-label" style="width: ">URL icon:</label>
                                            <input type="text" class="form-control w-100" name="icon" id="icon">
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="description" class="form-label">Description:</label>
                                            <textarea class="form-control w-100" name="description" id="description" rows="9"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="text-center mt-4 d-flex">
                                    <input type="submit" class="btn btn-primary btn-block" value="Add"  style="width: 80px; margin: 0 auto"/>

                                ...
                                <tbody>
                                    <c:forEach items="${listStaff}" var="ls">
                                        <tr>
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${ls.roleID == 1}">
                                                        Quản lý
                                                    </c:when>
                                                    <c:when test="${ls.roleID == 2}">
                                                        Kế toán
                                                    </c:when>
                                                    <c:when test="${ls.roleID == 6}">
                                                        Nhân viên hành chính
                                                    </c:when>
                                                    <c:when test="${ls.roleID == 8}">
                                                        Kĩ thuật
                                                    </c:when>
                                                    <c:when test="${ls.roleID == 9}">
                                                        Bảo vệ
                                                    </c:when>
                                                    <c:otherwise>
                                                        Unknown role
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Bạn có chắc chắn muốn chặn nhân viên này không?
                                                </div>

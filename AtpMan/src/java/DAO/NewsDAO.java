...
//news by page
    ...
    public boolean updateNews(News news) {
        String sql = "UPDATE News SET staffID = ?, taskID = ?, newsCategoryID = ?, newsTitle = ?, newsContent = ?, postDate = ?, newsImg = ?, newsDescription = ? WHERE newsID = ?";

...
//Nghia
    ...
    public void addResident(String name, String email, String phoneNumber, String dob, Date registrationDate, String isOwner) {
        ...
        try {
            conn = DBContext.getConnection();
            if (conn != null) {
                String sql = "INSERT INTO Customer (name, email, phoneNumber, dob, registrationDate, isOwner) VALUES (?, ?, ?, ?, ?, ?)";
                try (PreparedStatement ps = conn.prepareStatement(sql)) {
                    ps.setString(1, name);
    ...
    public static void main(String[] args) {
        CustomerDAO dao = new CustomerDAO();
        String username = "NghiaLT";
        String password = "123";
        System.out.println(""+dao.getAllInformationCustomer(username, password).toString());
    }
}
